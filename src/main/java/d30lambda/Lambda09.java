...
/*        // eHaric(myList);
       ...
       // bestenAzKucuk(myList); //ali elif
        ...
        tekrarsizKucuk(myList); //ali elif yusuf zeynep mustafa
    ...
    public static void tekrarsizBuyuk (List<String> myList) {
        ...
        // t'li yapılarda reversed() çalışmıyor. bu yüzden method reference lı halini kullanmak zorundayız.
        // Çünkü t'nin string mi ne olduğunu algılayamıyor.
