...
public class Queue01 {
    ...
    Queue interface'i, LinkedList ve PriorityQueue gibi farklı sınıflar tarafından uygulanabilir. */
       ...
       // System.out.println(depo.element());
        ...
        Deque<String> d = new LinkedList<>(); //d objesi hem deque hem linkedlist
        // Deque<String> d2 = new ArrayDeque<>(); Böyle de yazabilirdik.
        ...
        d.add("Oya");
        d.add("Tansu");
        System.out.println(d); //[Mehmet, Mahmut, Ekrem, Oya, Tansu] İnsertion order
