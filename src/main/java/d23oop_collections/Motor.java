...
public interface Motor {
    ...
    // abstract method olustururken 'abstract' keyword'unu ve 'method body' sini yazmayiz.
      ...
      /*
        ...
        Bu yüzden interface'lere "to do list " de denir.(yapilacaklar listesi)
                ...
                interface           	class       	==> 	 olamaz -->Bir interface baska bir class'ın child'i olamaz
        */

            /* Coklu interface parentlarin her birinin icine ayni isimli methodlar koyabiliriz
        ...
        //ambuguity (belirsizlik) hatası

    //5) Interface’ler de variable’lar default olarak public static final’dir.
    // Yani yazmasaniz da olur
    ...
    default void guc() { //default burada keyword'dür.
