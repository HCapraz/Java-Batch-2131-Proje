...
public class Maps02 {
    public static void main(String[] args) {
        ...
        System.out.println(stdAges.get("Jerry")); // null - get map'te key yoksa null döndürür
        System.out.println(stdAges.getOrDefault("Jerry", -1)); //Jerry map'te yok, default değer geldi
        //-------------------------------------
