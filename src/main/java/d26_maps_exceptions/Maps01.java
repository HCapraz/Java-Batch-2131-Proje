...
public class Maps01 {
    public static void main(String[] args) {
        ...
        stdAges.put(null, 41);
        stdAges.put(null, 39); //key bölümünde tek null olur. üzerine yazdı.
        stdAges.put("a", null);
        stdAges.put("b", null);
        ...
        */
        ...
        countryPopulation.put("Nerherland", 18000000);
        // countryPopulation.put(null, 18000000); HATA
        countryPopulation.put("France", null);
        countryPopulation.put("Italy", null);

        System.out.println(countryPopulation);
       // {France=null, Germany=83000000, Italy=null, Nerherland=18000000, Turkey=83000000, USA=400000000}
