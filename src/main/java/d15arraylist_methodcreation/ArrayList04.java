...
public class ArrayList04 {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(r); //41. satır olmayınca  [Nigde, Van] şeklinde yazılıyor.
        // Çünkü Java her seferinde indexlemeye baştan başlıyor.
        // 41. satır olunca "Vanéı da inceliyor ve istenen şekilde yazılıyor. Diğer durumda "Van"ı inceleyemeden döngü bitiyor.
