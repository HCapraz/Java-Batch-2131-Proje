...
public class StringManipulations03 {
    public static void main(String[] args) {
        ...
        // ii)Space karakteri password'de olmasin (space haric herşeyi silelim)
        boolean spaceControl = pwd.replaceAll("[^ ]", "").length()==0; //istemediğiniz şeyi sıfıra eşitleyin
        ...
        if (!digitControl) {
            System.out.println("En az bir rakam icermelidir");
